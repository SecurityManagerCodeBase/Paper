...
We also found applications that insisted on being run outside a sandbox. By default,
...
The developers of Eclipse and Timelage could have either: 1) painstakingly
...
detecting the sandbox and avoiding or disabling privileged operations) 2) gotten
the applications digitally signed by a recognized certificate authority and
configured them to be run without a sandbox. These developers likely found these 
alternatives to overly burdensome. The examples from our study suggest that
