...
\subsubsection{Reducing Web App Development Complexity}
\label{sub:Reducing-Web-Application-Complexity}
...
infer the developers' motivations. Both these applications attempted
to set the security manager to \texttt{null} at the beginning of execution.
This causes a restrictive sandbox to catch the security violation and
...
the applet in a restrictive \clg{Actually, wouldn't Eclipse need to be run
