...
Java applications are very popular targets for malicious attackers~\cite{xforceQ12013},% (see
...
that stores the proxy security manager. \todo{It is interesting because...}}
\end{figure}
