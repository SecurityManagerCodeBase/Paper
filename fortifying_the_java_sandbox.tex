...
including those requiring \texttt{PropertyPermissions}.\todo{how?} 
...
This permission set results in a defenseless security manager. \todo{why/how?
  One more half sentence}}
...
class.\todo{reference?  Did we observe this ourselves, or are we getting it from
  somewhere?} 
