...
\begin{tabular}{llll}
\toprule 
Application Name & Description & KLOC& Repo\tabularnewline
\midrule
...
JBoss & Application Middleware & 968 & QC\tabularnewline
...
Spring Framework & Web Dev. Library & 828 & QC\tabularnewline
...
AspectJ & Java Extension & 701 & GitHub\tabularnewline
%DemoPermissions & Spring Extension & Github\tabularnewline
driveddoc & Application Connector & 7 & GitHub\tabularnewline
%FileManager- & FTP Server & Github \\ FtpHttpServer\tabularnewline
Gjman & Development Toolkit & <1 & GitHub\tabularnewline
IntelliJ IDEA & IDE & 4094 & GitHub\tabularnewline
...
oxygen-libcore & Android Dev. Lib. & 1134 & GitHub\tabularnewline
refact4j & Meta-model Prog. Frwk. & 21 & GitHub\tabularnewline
Security-Manager & Alt. Security Manager & 4 & GitHub\tabularnewline
Spring-Modules & Spring Extension & 212 & GitHub\tabularnewline
System Rules & JUnit Extension & 2 & GitHub\tabularnewline
TimeLag & Sound Application & 1 & GitHub\tabularnewline
TracEE & JavaEE Support Tool & 18 & GitHub\tabularnewline
Visor & Closure Library & 1 & GitHub\tabularnewline
\bottomrule
\end{tabular}
\end{table}
...
achieved in a way that is known to be free of vulnerabilities.  \clg{I think
  ...
  We didn't find a vulnerability in it, what kind of evidence would we require that
...
from disabling \emph{self-protecting} managers.\clg{How many self protecting
  managers did we see in our study?  That is, how applicable are these in practice?}
...
interface. A more correct and general approach is to embed our
...
version 7 of the JRE.\clg{Claire wants a sentence here giving a couple of
  examples of what kind of exploits these CVEs include based on Zack's
  categorization.  Doesn't have to be definitive or complete, doesn't have to
  describe every exploit in the set, but should give an example or two.}
...
downloads.\clg{Can basically take these results to mean that our rules would
  stop all modern drive-by-download exploits in practice?  We imply/say
  elsewhere that other types of attacks are possible (type confusion to masquerade as a
  previleged class loader, for example); can we conclude that in practice they
  don't happen much?}
...
and because it can detect attacks that are not targeting the manager.\clg{isn't
  it also faster in this scenario because it doesn't turn off the JIT?} All  
